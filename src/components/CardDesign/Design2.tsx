...
const Design2 = ({data} : {data: IVcard}) => {
  return (
    <div className="flex flex-col bg-white border-2 rounded-xl shadow-lg">
        <div className="bg-gradient-to-r from-blue-500 via-green-500 to-yellow-500 w-full flex flex-col text-gray-100 p-4 pb-6 rounded-t-xl">
